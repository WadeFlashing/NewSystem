...
<html lang="zh-CN">
  <head>
    ...
    <style>
        * { margin: 0; padding: 0; }
        ...
        #name { background: url(images/emil.png) 20px 14px no-repeat; }
  ...
  <body>
     <div class="dowebok">
        <div class="logo"></div>
        <form  name="form1"  method="post" action="Checkmanager">
        <p align="middle"><font color="red">${msg}</font></p>
        <div class="form-item">
            <input  type="text" name="name" id="name"  placeholder="管理员账号">         
        </div>
        <div class="form-item">
            <input  type="password"  name="password" id="password" placeholder="管理员密码"> 
        </div>
        <div class="form-item"><button type="submit" id="submit" >登 录</button></div>
       
        </form>
        <div class="reg-bar">
        	<a class="reg" href="login" >返回用户登录</a>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
