  ...
  <%
	...
	%>
     ...
     <li style="float:right"><a>欢迎，${sessionScope.username} </a></li>
 	 <li style="float:right"><a class="active" href="login.jsp">退出</a></li> 	 
 	 <li style="float:right"><a href="topublish">发布新闻</a></li>
 	 <li style="float:right"><a href="mynews?&username=<%=username %>">我的新闻</a></li>
 	 <li style="float:right"><a href="view">新闻首页</a></li>
	 </ul>
	 <br><br><br>
	 <h2><center>修改新闻</center></h2>
	 ...
	 <br><br>
		...
		<textarea rows="15" cols="105" id="text" name="content" ><%=content %></textarea><br>
